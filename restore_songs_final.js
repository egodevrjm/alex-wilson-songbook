...
function main() {
  try {
    ...
    const log = {
      ...
      songs_with_notes: songsWithNotes,
      songs_with_sounds_like: songsWithSoundsLike,
      song_titles: songs.map(s => s.title)
    };
    
    fs.writeFileSync('restoration_log.json', JSON.stringify(log, null, 2));
...
export { parseSongsFromMarkdown, generateSongsFile, main };
